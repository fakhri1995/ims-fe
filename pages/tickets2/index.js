                    ...
                    <div className=' col-span-4 flex flex-col mb-6'>
                        ...
                        <div className="col-span-4 flex flex-col shadow-md rounded-md bg-white p-5 mt-2 mx-2 h-full">
                            <div className="flex flex-col justify-center h-full">
                                ...
                                <div className=" h-2/6 flex items-center mb-4 cursor-pointer hover:bg-backdrop p-2" onClick={() => { rt.push(`/tickets2/histories`) }}>
                                    <div className="flex p-1 bg-primary10 rounded mr-3">
                                ...
                                <div className=" h-2/6 flex items-center mb-4 cursor-pointer hover:bg-backdrop p-2" onClick={() => { rt.push(`/tickets2/tickettypes`) }}>
                                    <div className="flex p-1 bg-primary10 rounded mr-3">
