    ...
    return (
        <Layout tok={tok} dataProfile={dataProfile} pathArr={pathArr} sidemenu={sidemenu} originPath={originPath} st={st}>
            <>
                ...
                <Drawer title="New Vendor" maskClosable={false} visible={drawablecreate} onClose={() => { setDrawablecreate(false) }} destroyOnClose={true} width={700} footer={
                    <div style={{ textAlign: 'right' }}>
                            ...
                            <Form form={createVendorFrom} layout="vertical" onFinish={handleCreateVendor} style={{display:'contents'}} initialValues={newvendor}>
                            ...
                            <div className="pb-4 md:mb-0 ">
                                <Form.Item name="singkatan_nama" style={{ marginRight: `1rem` }} label="Singkatan Nama"
                                    ...
                                    initialValue={newvendor.singkatan_nama}
                                >
                            ...
                            <div className="pb-4 md:mb-0 ">
                                <Form.Item name="jabatan_pic" style={{ marginRight: `1rem` }} label="Jabatan Penanggung Jawab"
                                    ...
                                    initialValue={newvendor.jabatan_pic}
                                >
                            ...
                            <div className="pb-4 md:mb-0 ">
                                <Form.Item name="provinsi" style={{ marginRight: `1rem` }} label="Provinsi"
                                    ...
                                    initialValue={newvendor.provinsi}
                                >
                            ...
                            <div className="pb-4 md:mb-0 ">
                                <Form.Item name="kab_kota" style={{ marginRight: `1rem` }} label="Kab/Kota"
                                    ...
                                    initialValue={newvendor.kab_kota}
                                >
                            ...
                            <div className="pb-4 md:mb-0 ">
                                <Form.Item name="kode_pos" style={{ marginRight: `1rem` }} label="Kode Pos"
                                    ...
                                    initialValue={newvendor.kode_pos}
                                >
                            ...
                            <div className="pb-4 md:mb-0 ">
                                <Form.Item name="telepon" style={{ marginRight: `1rem` }} label="Telepon"
                                    ...
                                    initialValue={newvendor.telepon}
                                >
