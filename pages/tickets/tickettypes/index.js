...
const TicketTypes = ({ dataProfile, sidemenu, initProps }) => {
    ...
    const [loadingtickettypesdelete, setloadingtickettypesdelete] = useState(false)
    const [refreshcreatetickettypesdelete, setrefreshcreatetickettypesdelete] = useState(-1)
    ...
    return (
        <Layout dataProfile={dataProfile} sidemenu={sidemenu} tok={initProps} st={st} pathArr={pathArr}>
                    ...
                    <div className="flex justify-between items-center mb-5">
                        <div className="flex items-center">
                            ...
                            <div className=' flex items-center'>
                                    ...
                                    content={(
                                        <div className=' flex'>
                                            ...
                                            <div className=' flex flex-col'>
                                                <div className=' mb-2'>
                                                    <Label>
                                                        Halaman ini berisi daftar tiket dan task yang akan dijalankan berdasarkan tiket tersebut.
                                                    </Label>
                                                </div>
                                                <div>
                                                    <Label>
                                                        <strong>PENTING:</strong> Perubahan yang dilakukan akan mengubah seluruh alur task yang sedang berjalan
                                                    </Label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                >
                                    <ExclamationCircleOutlined style={{ color: `gray` }}></ExclamationCircleOutlined>
                                </Popover>
                            </div>
                        </div>
                        <div className="w-8/12 flex justify-end">
                            <div className=' mx-2'>
                                <ButtonSys type="primary" onClick={() => { setdrawertickettypescreate(true) }}>
            ...
            <DrawerTicketTypeCreate
                ...
                onClose={() => { setdrawertickettypescreate(false) }}
            ...
            <ModalHapusTipeTiket
                ...
                onCancel={() => { setmodaltickettypesdelete(false) }}
