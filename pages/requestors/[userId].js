            ...
            <div className="w-full h-auto grid grid-cols-4">
                <div className="col-span-3 flex flex-col" id="formAgentsWrapper">
                    <Sticky containerSelectorFocus="#formAgentsWrapper">
                        <div className="flex justify-between p-4 border-t-2 border-b-2 bg-white mb-8">
                            <h1 className="font-semibold py-2">Edit Requestors</h1>
                ...
                <div className="col-span-1 flex flex-col space-y-4 p-4">
                    ...
                    <p className="font-normal text-sm">
                        When you add a new requestor, you will have to provide the requestor’s email, set their permission levels and access (full-time or occasional). Requestors will receive an email with a confirmation link to activate their account after which they can be assigned to, or respond to tickets. Administrators can also edit an Requestor's profile to include the requestor’s title, phone, profile picture, signature etc.
                    </p>
                </div>
            </div>
        </Layout>
