                        ...
                        <>
                            {
                                ...
                                <Button type="primary" onClick={() => { rt.push(`/company/myCompany/updateProfile/${id}`) }}>Ubah</Button>
                            }
                        </>
                    }
                </div>
        ...
        data.map((item) => {
            ...
            const title =
                index > -1 ? (
                    ...
                    >
                        <div className="w-full" onClick={() => { rt.push(`/company/myCompany/locations/${item.id}?parent=${item.id_parent}&edit=`) }}>
                            {beforeStr}
                        ...
                        <div className={`hidden mx-2`} id={`node${item.key}`}>
                            {
                                ...
                                <a className="mx-2 pb-1" onClick={(e) => { rt.push(`/company/myCompany/locations/new?parent=${item.id}&frominduk=1`) }} alt="add"><PlusOutlined /></a>
                            }
                            {
                                // [151, 153, 154].every((curr) => dataProfile.data.registered_feature.includes(curr)) &&
                                <Link href={`/company/myCompany/locations/${item.id}?parent=${item.title}&edit=1`}>
            ...
            <div className="flex justify-start md:justify-end md:p-3 md:border-t-2 md:border-b-2 bg-white my-4 md:mb-5">
                <div className="flex space-x-2">
                    {/* <Link href={`/admin/company/locations/new?companyId=${dataDetailCompany.data.data.company_id}&parent=`}> */}
                    {
                        ...
                        <Button type="primary" size="middle" onClick={() => { rt.push(`/company/myCompany/locations/new?parent=&frominduk=0`) }}>Tambah</Button>
                    }
                    {/* </Link> */}
                </div>
            </div>
        ...
        fetch(`https://boiling-thicket-46501.herokuapp.com/addMainBank`, {
            ...
            .then(res2 => {
                ...
                if (res2.success) {
                    ...
                    setTimeout(() => {
                        setDrawablecreate(false)
                        rt.push(`/company/myCompany?active=bankAccounts`)
                        settambahdata(prev => !prev)
                    }, 500)
                }
                else {
                                    ...
                                    <>{actions[index]}
                                        {
                                            ...
                                            //     <EditOutlined />
                                            // </Button>
                                            <Button onClick={() => { rt.push(`/company/myCompany/bank/${record.id}`) }} style={{ paddingTop: `0`, paddingBottom: `0.3rem`, marginRight: `0.4rem` }}>
                                                <EditOutlined />
                                            </Button>
                                        }
                                        {
            ...
            <div className="flex justify-start md:justify-end md:p-3 md:border-t-2 md:border-b-2 bg-white my-4 md:mb-8">
                <div className="flex space-x-2">
                    ...
                    }
                    {
                        ...
                        <Button type="primary" onClick={() => { rt.push(`/company/myCompany/bank/create`) }}>Tambah</Button>
                    }
