                        ...
                        <div className="col-span-3 flex flex-col shadow-md rounded bg-white m-3">
                            <Spin spinning={editloading}>
                                                ...
                                                statusloading ?
                                                    ...
                                                    isenabled ?
                                                        <div className="flex justify-between">
                                                            ...
                                                            <Switch defaultChecked={true} onChange={(checked) => { setmodalstatus(true); setisenabled(checked); setstatusloading(true) }} />
                                                        </div>
                                                        :
                                                        <div className="flex justify-between">
                                                            <p className="font-semibold mb-0">Non Aktif</p>
                                                            <Switch defaultChecked={false} onChange={(checked) => { setmodalstatus(true); setisenabled(checked); setstatusloading(true) }} />
                                                        </div>
                                            }
                                        </div>
                                        <div className={`flex flex-col mb-5`}>
                                ...
                                <ModalStatus
                                    ...
                                    footer={
                                        <div className="flex justify-between items-center">
                                            <Buttonsys type="default" onClick={() => { setmodalstatus(false); setisenabled(rawdata.is_enabled); setstatusloading(false) }}>
                                                Batalkan
                                            </Buttonsys>
