            ...
            <div className="container-xl bg-blue-600 h-screen" /*style={{background:`linear-gradient(#035ea3, #198e07)`}}*/>
                <div className="pt-20 relative" id="wrapper">
                    <div className=" mx-auto bg-white rounded-lg w-10/12 md:w-5/12 max-h-80 md:max-h-80 text-black shadow-lg px-3 md:px-5 pt-10 pb-1 text-center">
                        <h1 className="mb-5 font-mont text-xl font-semibold">Buat Password Baru</h1>
                        <Form className="loginForm" onFinish={handleBuatPassword}>
                            <Form.Item name="new_password" rules={[
                                ...
                                <Input.Password prefix={<LockOutlined className="site-form-item-icon" />} name="new_password" value={formdata} placeholder="Password Baru" type={`password`} onChange={onChangeBuatPassword} />
                            </Form.Item>
                            <Form.Item name="confirm_new_password" rules={[
                                ...
                                <Input.Password prefix={<LockOutlined className="site-form-item-icon" />} name="confirm_new_password" value={formdata} placeholder="Konfirmasi Password Baru" type="password" onChange={(e) => { setkonfirmpass(e.target.value) }} />
                            </Form.Item>
                            <Form.Item style={{ justifyContent: `center` }}>
                                <Button type="primary" htmlType='submit' loading={loadingbuatpass} className="login-form-button mb-5" style={{ width: `100%` }}>
                                    Buat Password
                                </Button>
                            </Form.Item>
                        </Form>
