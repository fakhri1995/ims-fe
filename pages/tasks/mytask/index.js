...
const TaskIndex = ({ initProps, dataProfile, sidemenu }) => {
    ...
    const [lokasifilterstatetaskpick, setlokasifilterstatetaskpick] = useState("")
    const [fromdatefilterstatetaskpick, setfromdatefilterstatetaskpick] = useState("")
    const [todatefilterstatetaskpick, settodatefilterstatetaskpick] = useState("")
    const [tasktypefilterstatetaskpick, settasktypefilterstatetaskpick] = useState("")
        ...
        },
        {
            ...
            render: (text, record, index) => {
                return {
                    children:
                        <>
                            <Buttonsys type={`primary`} onClick={() => { handlePickTask(record.id) }}>
                                <div className="mr-1"><LayoutGridAddSvg size={18} color={`#ffffff`} /></div>
                                Ambil
                            </Buttonsys>
                        </>
                }
                                ...
                                <div className='px-5'>
                                    <div className='flex flex-col shadow-md rounded-lg bg-white p-5 mb-6 mx-3'>
                                        <div className="flex justify-between items-center mb-5">
                                            <div className="flex">
                                                <div className="mr-2 cursor-pointer" onClick={() => { setviewtaskpick(false) }}>
                                        ...
                                        <div className=' flex items-center mb-4'>
                                            <div className="mx-1 w-3/12">
                                                <Input value={searchfilterstatetaskpick} style={{ width: `100%` }} placeholder="Judul Task.." allowClear onChange={(e) => {
                                                    if (e.target.value === "") {
                                            ...
                                            <div className='mx-1 w-2/12'>
                                                <Select
                                                    ...
                                                    name={`task_type_id`}
                                                    onChange={(value) => { typeof (value) === 'undefined' ? settasktypefilterstatetaskpick("") : settasktypefilterstatetaskpick(value) }}
                                                >
                                                    {
                                            ...
                                            <div className=' w-3/12 mx-1'>
                                                <DatePicker.RangePicker showTime allowEmpty className="datepickerStatus" value={fromdatefilterstatetaskpick === "" ? [null, null] : [moment(fromdatefilterstatetaskpick), moment(todatefilterstatetaskpick)]} onChange={(dates, datestrings) => {
                                            ...
                                            <div className=' mx-1 w-3/12'>
                                                <TreeSelect
                                                    ...
                                                    showArrow
                                                    name={`locations_id`}
                                                    onChange={(value) => { typeof (value) === 'undefined' ? setlokasifilterstatetaskpick("") : setlokasifilterstatetaskpick(value) }}
                        ...
                        <div className="grid grid-cols-11 px-5" id="wrapper1">
                            ...
                            <div className="col-span-11 flex flex-col shadow-md rounded-md bg-white p-5 mb-6 mr-3">
                                ...
                                <div className="flex items-center justify-end">
                                    <div>
                                        <Buttonsys type={`primary`} onClick={() => { setviewtaskpick(true) }}>
                                            <div className="mr-1"><LayoutGridAddSvg size={18} color={`#ffffff`} /></div>
                                            Ambil Task Baru
                                        </Buttonsys>
                                    </div>
