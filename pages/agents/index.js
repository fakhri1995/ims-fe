            ...
            <>
                <div className="h-20 w-full grid grid-cols-1 md:grid-cols-3 border-gray-400 md:border-t md:border-b bg-white mb-5 p-4">
                    ...
                    <div className=" col-span-1 md:col-span-1 flex md:justify-end items-center">
                        ...
                        <div className=" text-white bg-gray-700 hover:bg-gray-900 cursor-pointer rounded-md h-10 py-3 md:py-2 w-24 md:w-32 text-center text-xs md:text-sm">New Agent</div>
                    </div>
                </div>
