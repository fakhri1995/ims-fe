...
function ClientUpdateProfile({ initProps, dataProfile, sidemenu, dataDetailCompany }) {
    const rt = useRouter()
    ...
    const [data1, setData1] = useState({
        ...
        tanggal_pkp: dataDetailCompany.data.tanggal_pkp === "" ? "-" : moment(dataDetailCompany.data.tanggal_pkp)/*moment(new Date())*/,
            ...
            <div id="profileDetailMigWrapper">
                <div className="flex justify-start md:justify-between p-3 md:border-t-2 md:border-b-2 bg-white mb-4 md:mb-8">
                    ...
                    <div className="flex space-x-2">
                        {editable ?
                            <Button type="default" onClick={() => { rt.push(`/admin/company/clients/${dataDetailCompany.data.company_id}`); }}>Batal</Button>
                            :
                            null
                        }
                        <>
