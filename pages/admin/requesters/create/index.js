                            ...
                            <div className="p-3 col-span-1 md:col-span-3">
                                ...
                                <Form layout="vertical" className="createAgentsForm" onFinish={handleCreateAgents} form={instanceForm}>
                                    ...
                                    <Form.Item label="Konfirmasi Password" name="password"
                                        ...
                                        <>
                                            <Input.Password value={newuserrequesters.confirm_password} name={`confirm_password`} onChange={onChangeCreateRequesters} />
                                            {
                                                newuserrequesters.password !== newuserrequesters.confirm_password &&
                                                <p className=" text-red-500 mb-0">Confirm Password harus sesuai dengan password</p>
                                            }
                                        </>
                                    </Form.Item>
                                    <Form.Item label="Role" name="role">
                                        <Select mode="multiple" onChange={(value) => { setNewuserrequesters({ ...newuserrequesters, role_ids: value }) }} /*defaultValue={idrole}*/ style={{ width: `100%` }}>
                                            {
