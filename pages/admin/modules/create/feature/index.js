...
const FeatureCreate = ({ sidemenu, initProps, dataProfile }) => {
    //1. Init
    const rt = useRouter()
    ...
    return (
        <Layout sidemenu={sidemenu} dataProfile={dataProfile} st={st} tok={initProps} pathArr={pathArr}>
                    ...
                    <div className="shadow-lg flex flex-col rounded-md w-full h-auto p-4 mb-14">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4">
                            <div className="p-3 col-span-1 md:col-span-3">
                                <Form layout="vertical" form={instanceForm} className="createAgentsForm" onFinish={handleCreateFeature}>
                                    <Form.Item label="Nama Fitur" required name="name"
                                        rules={[
                                            {
                                                required: true,
                                        ...
                                        <Input value={newdata.name} name={`name`} onChange={(e) => {
                                            setnewdata({
                                                ...newdata,
                                                name: e.target.value
                                            })
                                    ...
                                    <Form.Item label="Deskripsi" required name="description"
                                        ...
                                        <Input.TextArea rows={4} value={newdata.description} name={`description`} onChange={(e) => {
                                            setnewdata({
                                                ...newdata,
