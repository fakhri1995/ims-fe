    ...
    return (
        <Layout>
                ...
                <div className={'block md:flex'}>
                    <div className={'flex py-4'}>
                        <Linkk activeClass="active"
                            ...
                            offset={-120}
                            className={'mr-12'}
                            duration={500}><button className={'gilroy-regular text-xl text-black cursor-pointer flex-col focus:outline-none jot-underlined'} style={{}}>Our Values
                            </button></Linkk>
                        <Linkk activeClass="active"
                            to="section6careers"
                            spy={true}
                            ...
                            offset={-120}
                            className={'mr-12'}
                            duration={500}><button className={'gilroy-regular text-xl text-black cursor-pointer flex-col focus:outline-none jot-underlined'} style={{}}>Benefits
                            </button></Linkk>
                        <Linkk activeClass="active"
                            to="section7careers"
                            spy={true}
                            ...
                            offset={-150}
                            className={'mr-12'}
                            duration={500}><button className={'gilroy-regular text-xl text-black cursor-pointer flex-col focus:outline-none jot-underlined'} style={{}}>Careers
                            </button></Linkk>
                    </div>
                </div>
            </section>
            ...
            <section className={'section3careers py-10 px-4 sm:px-10 md:px-10 lg:px-10 xl:px-10 2xl:px-20'} >
                ...
                <div>
                    <p className={'text-3xl md:text-4xl gilroy-bold text-center pb-8'}>Our Values</p>
                </div>
                ...
                <div className={'md:flex justify-between'}>
                    ...
                    <div className={'flex-col flex bg-white mr-0 md:mr-10 p-4 w-auto border-2 border-black-300 rounded-lg hover:shadow-lg mb-4'}>
                        <div>
                            ...
                            <br></br>
                            <p className={'text-left pr-4 text-base md:text-xl'}>We are dedicated to adhering to positive ethical values.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className={'section6careers py-10 px-4 sm:px-10 md:px-10 lg:px-10 xl:px-10 2xl:px-20 h-auto'}>
                ...
                <div className={'justify-center'}>
                    <p className={'text-center gilroy-bold text-3xl md:text-4xl pb-8'}>Benefits</p>
                    ...
                    <div className={'block md:flex md:flex-row justify-center object-scale-down text-base'}>
                        <div className={'block md:flex md:flex-col justify-center md:w-1/2'}>
                            <div className={'pb-6 flex-row flex '}>
                                <img className={'flex-row'} src='/image/joinourteam/benefit_1.png' style={{height:30}}></img>
                                <p className={'flex-row my-auto pl-4'}>
                                    We love to empower our team members to solve problems that matter
                                </p>
                            </div>
                            <div className={'pb-6 flex-row flex'}>
                                <img className={'flex-row'} src='/image/joinourteam/benefit_2.png' style={{height:30}}></img>
                                <p className={'flex-row my-auto pl-4'}>
                                    We offer diverse industry exposures and hands-on experience
                                </p>
                            </div>
                            <div className={'pb-6 flex-row flex'}>
                                <img className={'flex-row'} src='/image/joinourteam/benefit_3.png' style={{height:30}}></img>
                                <p className={'flex-row my-auto pl-4'}>
                        ...
                        <div className={'block md:flex md:flex-col justify-center md:w-1/2'}>
                            <div className={'pb-6 flex-row flex'}>
                                <img className={'flex-row'} src='/image/joinourteam/benefit_4.png' style={{height:30}}></img>
                                <p className={'flex-row my-auto pl-4'}>
                                    We provide unique and competitive packages to launch your career
                                </p>
                            </div>
                            <div className={'pb-6 flex-row flex'}>
                                <img className={'flex-row'} src='/image/joinourteam/benefit_5.png' style={{height:30}}></img>
                                <p className={'flex-row my-auto pl-4'}>
                                    We value informal social bonding to offer a enjoyable working environment
                                </p>
                            </div>
                            <div className={'pb-6 flex-row flex'}>
                                <img className={'flex-row'} src='/image/joinourteam/benefit_6.png' style={{height:30}}></img>
                                <p className={'flex-row my-auto pl-4'}>
