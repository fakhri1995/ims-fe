            ...
            <section className={'section1landingpage py-8 px-4 md:px-20 lg:px-28 xl:px-40'}>
                <div className={'block md:flex'}>
                    <div className={'flex-col center'}>
                        <div className={''}>
                            <p className={'text-3xl md:text-4xl pb-6 font-bold gilroy-bold'} style={{ letterSpacing:'1.5px' }}>Your One Stop,
                ...
                <div className={'block md:flex justify-between'}>
                    ...
                    <div className={'flex'}>
                        <div className={'flex-col text-black p-4 md:py-2'} style={{margin:'0 auto 0', width:'200px'}}>
                            <p className={'text-5xl md:text-6xl text-center gilroy-medium '}>20+</p>
                            <p className={'text-base text-center gilroy-medium'} style={{margin:'0 auto 0'}}>cities</p>
                        </div>
                        <div className={'flex-col text-black p-4 md:py-2'} style={{margin:'0 auto 0', width:'200px'}}>
                            <p className={'text-5xl md:text-6xl text-center gilroy-medium '}>9000+</p>
                            <p className={'text-base text-center gilroy-medium'} style={{margin:'0 auto 0'}}>managed and leased devices</p>
                        </div>
                        <div className={'flex-col text-black p-4 md:py-2'} style={{margin:'0 auto 0', width:'200px'}}>
                            <p className={'text-5xl md:text-6xl text-center gilroy-medium '}>20+</p>
                            <p className={'text-base text-center gilroy-medium'} style={{margin:'0 auto 0'}}>years experienced</p>
                        </div>
                    </div>
                </div>
            </section>
            <section className={'section3landingpage static md:relative px-4 md:px-20 lg:px-28 xl:px-40'} style={{backgroundColor:'white'}}>
