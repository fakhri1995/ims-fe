...
function Talents({ }) {
    ...
    return (
        <Layout>
            ...
            <section className={'section2people py-8 md:py-0 px-4 sm:px-10 md:px-10 lg:px-10 xl:px-10 2xl:px-20'}>
                ...
                <div className={'block md:hidden'}>
                    <div className={'my-auto'}>
                        ...
                        <p className={'pb-4 gilroy-medium text-xl'}>Large quantity of profiles coming in with widely different qualities. Your turnover rate is high and you have to do it all over again.</p>
