                    ...
                    <div className={'flex flex-rowflex-row'}>
                        <div className={'w-1/2'}>
                            ...
                            <div>
                                ...
                                <Link href={{pathname: '/talents'}}><p className={'cursor-pointer gilroy-regular pb-1 menu-underlined w-min text-base'}>Talents</p></Link>
                            </div>
                        </div>
                        <div className={'w-1/2'}>
                            <div className={'pb-8'}>
                            ...
                            <div className={'pb-8'}>
                                <Link href={{pathname: '/contactus'}}><p className={'cursor-pointer gilroy-bold menu-underlined w-min text-base'}>Contact&nbsp;Us</p></Link>
                            </div>
                            <div>
                                <Link href={{pathname: '/privacy'}}><p className={'cursor-pointer gilroy-bold menu-underlined w-min text-base'}>Privacy</p></Link>
                                <Link href={{pathname: '/term'}}><p className={'cursor-pointer gilroy-bold menu-underlined w-min text-base'}>Term&nbsp;of&nbsp;Use</p></Link>
                            </div>
                        </div>
                    </div>
                </div>
