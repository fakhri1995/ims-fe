                ...
                >
                    <div className={'w-full'}>
                        ...
                        <div>
                            ...
                            <p>Transform your business with our custom solutions to optimize your cost and productivity.</p>
                        </div>
                    </div>
                    <div className={'w-full'}>
                        <div className={'w-40 h-56 m-auto'}>
                        ...
                        <div>
                            ...
                            <p>A partner you can trust, with more than 15 years of experiences-we’re here for the long run.</p>
                        </div>
                    </div>
                    <div className={'w-full'}>
                        <div className={'w-40 h-56 m-auto'}>
                        ...
                        <div>
                            ...
                            <p>We offer the best services with the best price tailored to your needs.</p>
                        </div>
                    </div>
                    <div className={'w-full'}>
                        <div className={'w-40 h-56 m-auto'}>
                        ...
                        <div>
                            ...
                            <p>Customer driven, we help you grow and offer solutions to help optimized your bussiness. </p>
                        </div>
                    </div>
                </Flickity>
            </section>
