...
const ArrowUpRightIconSvg = ({ size, color }) => {
  ...
  return <Icon rev={""} component={arrowUpRightlIconSvg}></Icon>;
};

const BulbIconSvg = ({ size, color }) => {
  const bulbIconSvg = () => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
const CopyrightIconSvg = ({ size, color }) => {
  ...
  return <Icon rev={""} component={copyrightIconSvg}></Icon>;
};
  ...
  const calendarFilIconSvg = () => (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.586 21.414C2 20.828 2 19.886 2 18V13C2 12.529 2 12.293 2.146 12.146C2.293 12 2.53 12 3 12H21C21.471 12 21.707 12 21.854 12.146C22 12.293 22 12.529 22 13V18C22 19.886 22 20.828 21.414 21.414C20.828 22 19.886 22 18 22H6C4.114 22 3.172 22 2.586 21.414ZM8 16C7.73478 16 7.48043 16.1054 7.29289 16.2929C7.10536 16.4804 7 16.7348 7 17C7 17.2652 7.10536 17.5196 7.29289 17.7071C7.48043 17.8946 7.73478 18 8 18H16C16.2652 18 16.5196 17.8946 16.7071 17.7071C16.8946 17.5196 17 17.2652 17 17C17 16.7348 16.8946 16.4804 16.7071 16.2929C16.5196 16.1054 16.2652 16 16 16H8Z"
        fill={props.color ?? "currentColor"}
      />
      <path
        d="M7 3V6M17 3V6"
