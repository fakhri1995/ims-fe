      ...
      fetch(
        ...
        .then((res2) => {
          var worksdetail = res2.data.task_details.filter(
            (docfil) => docfil.id === Number(id)
          )[0];
          if (
            worksdetail.component.type === 1 ||
            worksdetail.component.type === 2
          ) {
            setdatadisplay({
              ...datadisplay,
            ...
            worksdetail.component.is_general === true
              ? setisbarismatriks(true)
              : setisbarismatriks(false);
          ...
          worksdetail.component.name !== "" &&
          worksdetail.component.type !== null
                                    ...
                                    onChange={async (value) => {
                                      ...
                                      if (prevtype === datadisplay.type) {
                                        if (idx3 - (dynamniclen - 1) <= 0) {
                                          ...
                                          var templists = [
                                            ...dataupdate.work.add_rows,
                                          ];
                                          templists[idx3 - dynamniclen] = {
                                            ...doc3,
                                            type: value,
                                          };
                                          setdataupdate((prev) => ({
                                  ...
                                  if (idx4 - (dynamniclen - 1) <= 0) {
                                    setdataupdate((prev) => ({
                                      ...
                                      work: {
                                        ...
                                        delete_rows: [
                                          ...prev.work.delete_rows,
                                          dataupdate.work.lists.indexOf(doc4),
                                        ],
                                      },
                                    }));
                                    setdynamniclen((prev) => prev - 1);
