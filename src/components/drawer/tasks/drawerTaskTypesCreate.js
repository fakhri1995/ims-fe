...
const DrawerTaskTypesCreate = ({
  ...
  const [loadingtasktypenameexist, setloadingtasktypenameexist] =
    useState(false);
  //checkbox
                    ...
                    onBlur={(e) => {
                      ...
                      fetch(
                        ...
                        .then((res2) => {
                          ...
                          res2.data.length === 0
                            ? settasktypenameexist(false)
                            : settasktypenameexist(true);
                          setdisabledtrigger((prev) => prev + 1);
                        });
                    }}
                  ></Input>
                  ...
                  {loadingtasktypenameexist ? (
                    ...
                    tasktypenameexist === true ? (
                      <div className=" bg-overdue bg-opacity-10 text-overdue px-2 py-2 rounded flex items-center text-2xs">
                        <div className=" mr-1">
                          <AlertIconSvg size={15} color={`#BF4A40`} />
                        </div>
                        Tipe task sudah ada
                      </div>
                    ) : (
                      <div className=" bg-open bg-opacity-10 text-open px-2 py-2 rounded flex items-center text-2xs">
                        <div className=" mr-1">
                          <CheckIconSvg size={15} color={`#2F80ED`} />
                        </div>
