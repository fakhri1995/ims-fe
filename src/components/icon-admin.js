  ...
  const svgagents = () => (
    ...
    >
      <g id="Engineer-2" data-name="Engineer">
        <path d="M42,23H39v6h3a3,3,0,0,0,0-6Z" style={{ fill: "#f1cfa2" }} />
        <path d="M15,23H14a3,3,0,0,0,0,6h3V23Z" style={{ fill: "#f1cfa2" }} />
        <path
        ...
        <path
          ...
          style={{ fill: "#ffa733" }}
        />
        <path d="M41,21v6a13,13,0,0,1-26,0V21Z" style={{ fill: "#ffdaaa" }} />
        <circle cx={48} cy={48} r={5} style={{ fill: "#ff6243" }} />
        <path
        ...
        <path
          ...
          style={{ fill: "#ffdaaa" }}
        />
        <path d="M26,5V17H14A12,12,0,0,1,26,5Z" style={{ fill: "#ffa733" }} />
        <path
        ...
        <path
          ...
          style={{ fill: "#ff9811" }}
        />
        <rect x={15} y={21} width={26} height={2} style={{ fill: "#f1cfa2" }} />
        <path
    ...
    >
      <g id="Engineer">
        <path
          ...
          style={{ fill: "#78b9eb" }}
        />
        <rect x={6} y={55} width={52} height={6} style={{ fill: "#acabb1" }} />
        <polygon
        ...
        <polygon
          ...
          style={{ fill: "#acabb1" }}
        />
        <polygon points="51 35 52 42 46 41 51 35" style={{ fill: "#1e81ce" }} />
        <polygon points="41 35 46 41 40 42 41 35" style={{ fill: "#1e81ce" }} />
        <path
        ...
        <path
          ...
          style={{ fill: "#3d9ae2" }}
        />
        <polygon points="51 35 46 41 41 35 51 35" style={{ fill: "#ffdaaa" }} />
        <path d="M52,23v4a6,6,0,0,1-12,0V23Z" style={{ fill: "#ffdaaa" }} />
        <path
        ...
        <path
          ...
          style={{ fill: "#ffa733" }}
        />
        <rect x={6} y={55} width={52} height={2} style={{ fill: "#898890" }} />
        <rect x={53} y={43} width={2} height={8} style={{ fill: "#3d9ae2" }} />
        <rect x={37} y={43} width={2} height={8} style={{ fill: "#1e81ce" }} />
      </g>
    </svg>
  );
  return (
...
const IconRoles = (props) => {
  const svgroles = () => (
    ...
    >
      <g id="Browser">
        <path d="M53,11V53H7a4,4,0,0,1-4-4V11Z" style={{ fill: "#78b9eb" }} />
        <polygon
        ...
        <path
          ...
          style={{ fill: "#ff7956" }}
        />
        <circle cx={46} cy={46} r={6} style={{ fill: "#ff6243" }} />
        <rect x={8} y={6} width={2} height={2} style={{ fill: "#ffd422" }} />
        <rect x={12} y={6} width={2} height={2} style={{ fill: "#00ccb3" }} />
        <rect x={16} y={6} width={2} height={2} style={{ fill: "#ff5023" }} />
        <rect x={22} y={6} width={22} height={2} style={{ fill: "#e6e7e8" }} />
        <rect x={9} y={42} width={16} height={2} style={{ fill: "#3d9ae2" }} />
        <rect x={9} y={46} width={16} height={2} style={{ fill: "#3d9ae2" }} />
        <rect x={27} y={26} width={2} height={2} style={{ fill: "#ffcd00" }} />
        <rect x={31} y={26} width={4} height={2} style={{ fill: "#ffcd00" }} />
        <rect x={21} y={26} width={4} height={2} style={{ fill: "#ffcd00" }} />
        <rect x={45} y={35} width={2} height={2} style={{ fill: "#ee8700" }} />
        <rect
          x="37.929"
          y="37.929"
          width={2}
          ...
          style={{ fill: "#ee8700" }}
        />
        <rect x={35} y={45} width={2} height={2} style={{ fill: "#ee8700" }} />
        <rect
          x="37.929"
          y="52.071"
          width={2}
          ...
          style={{ fill: "#ee8700" }}
        />
        <rect x={45} y={55} width={2} height={2} style={{ fill: "#ee8700" }} />
        <rect
          x="52.071"
          y="52.071"
          width={2}
          ...
          style={{ fill: "#ee8700" }}
        />
        <rect x={55} y={45} width={2} height={2} style={{ fill: "#ee8700" }} />
        <rect
          x="52.071"
          y="37.929"
          width={2}
  ...
  const svgmodules = () => (
    ...
    >
      <g id="Setting">
        ...
        <rect x={31} y={18} width={2} height={2} style={{ fill: "#ee8700" }} />
        <rect
          x="21.808"
          y="21.808"
          width={2}
        ...
        <rect
          ...
          style={{ fill: "#ee8700" }}
        />
        <rect x={31} y={44} width={2} height={2} style={{ fill: "#ee8700" }} />
        <rect
          x="40.192"
          y="40.192"
          width={2}
        ...
        <rect
          ...
          style={{ fill: "#ee8700" }}
        />
        <rect x={18} y={31} width={2} height={2} style={{ fill: "#ee8700" }} />
        <rect x={44} y={31} width={2} height={2} style={{ fill: "#ee8700" }} />
        <path
  ...
  const svgmigcompany = () => (
    ...
    >
      ...
      <g>
        <path
          style={{ fill: "#00D7DF" }}
          d="M376,24V8c0-4.418-3.582-8-8-8H112c-4.418,0-8,3.582-8,8v16c0,4.418,3.582,8,8,8h256
...
const IconClientsCompany = (props) => {
  const svgclientscompany = () => (
    ...
    >
      ...
      <path
        style={{ fill: "#FBB040" }}
        d="M224,0H16c-4.418,0-8,3.582-8,8v472h152V152h72V8C232,3.582,228.418,0,224,0z M72,384H40v-32h32V384z
	...
	h32V64z M200,120h-32V96h32V120z M200,64h-32V32h32V64z"
      ...
      <path
        style={{ fill: "#FF9811" }}
        d="M376,128H168c-4.418,0-8,3.582-8,8v344h152V288h72V136C384,131.582,380.418,128,376,128z M224,384
	...
	h-32v-32h32V320z M288,256h-32v-32h32V256z M288,192h-32v-32h32V192z M352,248h-32v-24h32V248z M352,192h-32v-32h32V192z"
      ...
      <path
        style={{ fill: "#FF5023" }}
        d="M464,256H320c-4.418,0-8,3.582-8,8v216h160V264C472,259.582,468.418,256,464,256z M376,384h-32v-32
...
const IconAssets = (props) => {
  const svgAssets = () => (
    ...
    >
      ...
      />
      <g fill="#f4b844">
        <path d="m46.457031 130.96875 85.214844-84.816406 11.289063 11.339844-85.214844 84.816406zm0 0" />
        <path d="m24.886719 180.839844h16v120h-16zm0 0" />
        <path d="m46.128906 351.414062 11.316406-11.3125 86.128907 86.140626-11.316407 11.3125zm0 0" />
        <path d="m181.886719 441.839844h120v16h-120zm0 0" />
        <path d="m340.152344 425.898438 11.347656 11.28125 85.226562-85.738282.109376-.109375-11.363282-11.265625zm0 0" />
        <path d="m440.886719 300.839844h16v-120l-16 .019531zm0 0" />
        <path d="m340.441406 57.628906 11.3125-11.3125 84.839844 84.828125-11.3125 11.316407zm0 0" />
        <path d="m181.886719 25.839844h120v16h-120zm0 0" />
      </g>
      <path
    ...
    >
      <g id="Truck">
        ...
        <path
          ...
          style={{ fill: "#787680" }}
        />
        <rect x={3} y={15} width={30} height={24} style={{ fill: "#78b9eb" }} />
        <path
        ...
        <rect
          ...
          style={{ fill: "#e6e7e8" }}
        />
        <circle cx={18} cy={27} r={3} style={{ fill: "#ff6243" }} />
        <rect x={58} y={44} width={3} height={2} style={{ fill: "#e6e7e8" }} />
        <path
    ...
    >
      <g>
        ...
        <path
          ...
          fill="#c5d3de"
        />
        <path d="m386 314h72v90h-72z" fill="#ffee80" />
        <path d="m274 314h72v90h-72z" fill="#d5ea79" />
        <path d="m162 314h72v90h-72z" fill="#e6e6f9" />
        <path d="m386 184h72v90h-72z" fill="#eaf5bc" />
        <path d="m274 184h72v90h-72z" fill="#8481e2" />
        <path d="m162 184h72v90h-72z" fill="#fff2a0" />
        <path
...
const IconDepreciation = (props) => {
  const svgdepreciation = () => (
    ...
    >
      ...
      >
        <circle cx="32" cy="22" fill="#ffe477" r="19" />
        <path
        ...
        />
        <g fill="#ddb200">
          <path d="m31 29.82a2.772 2.772 0 0 1 -1 .18 3 3 0 0 1 -3-3h2a2.968 2.968 0 0 0 2 2.82z" />
          <path d="m39 27a7.005 7.005 0 0 1 -5 6.71v3.29h-2v-3.29a7 7 0 0 0 -2-13.71 3 3 0 0 1 0-6 2.772 2.772 0 0 1 1 .18 3 3 0 0 0 1 5.82 7 7 0 0 1 7 7z" />
          <path d="m32 10.29v-3.29h2v3.29a7.005 7.005 0 0 1 5 6.71h-2a7.005 7.005 0 0 0 -5-6.71z" />
        </g>
        <path d="m61 49-5 8-5-8h3v-46h4v46z" fill="#ff3051" />
        <path d="m61 49-5 8v-54h2v46z" fill="#cd2a00" />
        <path d="m37 53-5 8-5-8h3v-8h4v8z" fill="#ff3051" />
        <path d="m37 53-5 8v-16h2v8z" fill="#cd2a00" />
        <path d="m13 49-5 8-5-8h3v-46h4v46z" fill="#ff3051" />
        <path d="m13 49-5 8v-54h2v46z" fill="#cd2a00" />
        <path d="m32 15a2 2 0 0 1 2 2 1 1 0 0 0 1 1h4a1 1 0 0 0 1-1 8.054 8.054 0 0 0 -5-7.414v-2.586a1 1 0 0 0 -1-1h-4a1 1 0 0 0 -1 1v2.586a8 8 0 0 0 3 15.414 2 2 0 1 1 -2 2 1 1 0 0 0 -1-1h-4a1 1 0 0 0 -1 1 8.054 8.054 0 0 0 5 7.414v2.586a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-2.586a8 8 0 0 0 -3-15.414 2 2 0 0 1 0-4zm0 6a6 6 0 0 1 1.715 11.748 1 1 0 0 0 -.715.958v2.294h-2v-2.294a1 1 0 0 0 -.715-.958 6.043 6.043 0 0 1 -4.2-4.748h2.041a4 4 0 1 0 3.874-5 6 6 0 0 1 -1.715-11.748 1 1 0 0 0 .715-.958v-2.294h2v2.294a1 1 0 0 0 .715.958 6.043 6.043 0 0 1 4.2 4.748h-2.041a4 4 0 1 0 -3.874 5z" />
        <path d="m32 2a20 20 0 1 0 20 20 20.023 20.023 0 0 0 -20-20zm0 38a18 18 0 1 1 18-18 18.021 18.021 0 0 1 -18 18z" />
        <path d="m37 52h-2v-7a1 1 0 0 0 -1-1h-4a1 1 0 0 0 -1 1v7h-2a1 1 0 0 0 -.848 1.53l5 8a1 1 0 0 0 1.7 0l5-8a1 1 0 0 0 -.852-1.53zm-5 7.113-3.2-5.113h1.2a1 1 0 0 0 1-1v-7h2v7a1 1 0 0 0 1 1h1.2z" />
        <path d="m13 48h-2v-45a1 1 0 0 0 -1-1h-4a1 1 0 0 0 -1 1v45h-2a1 1 0 0 0 -.848 1.53l5 8a1 1 0 0 0 1.7 0l5-8a1 1 0 0 0 -.852-1.53zm-5 7.113-3.2-5.113h1.2a1 1 0 0 0 1-1v-45h2v45a1 1 0 0 0 1 1h1.2z" />
        <path d="m61.875 48.516a1 1 0 0 0 -.875-.516h-2v-45a1 1 0 0 0 -1-1h-4a1 1 0 0 0 -1 1v45h-2a1 1 0 0 0 -.848 1.53l5 8a1 1 0 0 0 1.7 0l5-8a1 1 0 0 0 .023-1.014zm-5.875 6.597-3.2-5.113h1.2a1 1 0 0 0 1-1v-45h2v45a1 1 0 0 0 1 1h1.2z" />
      </g>
    </svg>
  );
  return (
      ...
      <g>
        <g>
          ...
          <path
            ...
            fill="#966a5b"
          />
          <circle cx="304.097" cy="304.097" fill="#dad8db" r="96.194" />
          <path
            ...
            fill="#c8c5c9"
          />
          <circle cx="304.097" cy="304.097" fill="#fff" r="64.129" />
          <path
