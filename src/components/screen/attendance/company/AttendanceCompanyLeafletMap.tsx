...
import styles from "./AttendanceCompanyLeafletMap.module.scss";

/**
 * Component AttendanceCompanyLeafletMap's props.
 */
export interface IAttendanceCompanyLeafletMap {}

/**
 * Component AttendanceCompanyLeafletMap
 */
export const AttendanceCompanyLeafletMap: FC<
  IAttendanceCompanyLeafletMap
> = () => {
  return (
