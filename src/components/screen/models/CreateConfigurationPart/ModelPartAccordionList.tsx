...
export interface IModelPartAccordionList {
  ...
  /** Record model id (key) beserta quantitynya (value). Digunakan untuk render <Panel> sebanyak quantity */
  modelPartQuantityRecord?: Record<number, number>;
  ...
  return (
    <Collapse accordion>
      {modelPartData.map((doc, idx) => {
        ...
        if (modelId in modelPartQuantityRecord) {
          renderCount = modelPartQuantityRecord[modelId];
        }
