 ...
 */
export const FormAddDetailsActivityDrawer: FC<IFormAktivitasDrawer> = ({
  title,
  visible,
  onvisible,
  buttonOkText,
  ...
  const { mutate: addDetailAktivitas, isLoading: updateFormLoading } =
    useAddFormAktivitasDetails();
  ...
  const handleSaveForm = () => {
    ...
    if (!isAllowedToCreateForm) {
      permissionWarningNotification("Add Details", "Form Aktivitas");
      return;
    }

    addDetailAktivitas(payload, {
      onSuccess: (response) => {
      ...
      onError: (error: AxiosError<any, any>) => {
        notification.error({
          message: `Gagal menambahkan detail form aktivitas. ${error.response.data.message}`,
          duration: 3,
        });
      },
    });
  ...
  return (
    <DrawerCore
      ...
      onButtonCancelClicked={undefined}
      onClick={handleSaveForm}
      disabled={disabledcreate}
    >
      <Spin spinning={updateFormLoading}>
                      ...
                      <div key={idx} className="grid grid-cols-2 mb-3">
                        ...
                        <div className="col-span-1 ml-1 mb-3">
                          ...
                          >
                            ...
                            <Select.Option value={FormAktivitasTypes.PARAGRAPH}>
                              <div className="flex items-center">
                                <AlignJustifiedIconSvg
                                  size={12}
                                  color={`#35763B`}
                            ...
                            <Select.Option value={FormAktivitasTypes.CHECKLIST}>
                              <div className="flex items-center">
                            ...
                            <Select.Option value={FormAktivitasTypes.DROPDOWN}>
                              <div className="flex items-center">
                                <ListNumbersSvg size={12} color={`#35763B`} />
                                Dropdown
                              </div>
