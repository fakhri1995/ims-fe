...
/** Attendance Schedule */
export const ATTENDANCE_SCHEDULES_GET = "ATTENDANCE_SCHEDULES_GET";
export const ATTENDANCE_SCHEDULE_GET = "ATTENDANCE_SCHEDULE_GET";
export const ATTENDANCE_SCHEDULE_ADD = "ATTENDANCE_SCHEDULE_ADD";
export const ATTENDANCE_SCHEDULE_UPDATE = "ATTENDANCE_SCHEDULE_UPDATE";
export const ATTENDANCE_SCHEDULE_DELETE = "ATTENDANCE_SCHEDULE_DELETE";
export const ATTENDANCE_SCHEDULE_ALL_DELETE = "ATTENDANCE_SCHEDULE_ALL_DELETE";
export const ATTENDANCE_CURRENT_SCHEDULE_GET =
