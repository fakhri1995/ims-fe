...
export const SIDEBAR_ATTENDANCE_SHIFT = "SIDEBAR_ATTENDANCE_SHIFT";
export const SIDEBAR_ATTENDANCE_SCHEDULE = "SIDEBAR_ATTENDANCE_SCHEDULE";
...
/** Notification */
export const SIDEBAR_ANNOUNCEMENT = "SIDEBAR_ANNOUNCEMENT";
...
export const SIDEBAR_EMPLOYEE_PAYSLIP = "SIDEBAR_EMPLOYEE_PAYSLIP";
...
export const SIDEBAR_RECRUITMENT_TALENT_POOL =
...
export const ATTENDANCE_TASK_ACTIVITY_ADD = "ATTENDANCE_TASK_ACTIVITY_ADD";
export const ATTENDANCE_TASK_ACTIVITY_DELETE =
  "ATTENDANCE_TASK_ACTIVITY_DELETE";
export const ATTENDANCE_USERS_PAGINATE_GET = "ATTENDANCE_USERS_PAGINATE_GET";
...
export const ATTENDANCE_TASK_ACTIVITIES_ADMIN_GET =
  "ATTENDANCE_TASK_ACTIVITIES_ADMIN_GET";
export const ATTENDANCE_TASK_ACTIVITIES_GET = "ATTENDANCE_TASK_ACTIVITIES_GET";
...
/** Attendance Shift */
export const ATTENDANCE_SHIFTS_GET = "SHIFTS_GET";
export const ATTENDANCE_SHIFT_GET = "SHIFT_GET";
export const ATTENDANCE_SHIFT_ADD = "SHIFT_ADD";
export const ATTENDANCE_SHIFT_UPDATE = "SHIFT_UPDATE";
export const ATTENDANCE_SHIFT_DELETE = "SHIFT_DELETE";

/** Attendance Schedule */
export const ATTENDANCE_SCHEDULES_GET = "SCHEDULES_GET";
export const ATTENDANCE_SCHEDULE_GET = "SCHEDULE_GET";
export const ATTENDANCE_SCHEDULE_ADD = "SCHEDULE_ADD";
export const ATTENDANCE_SCHEDULE_UPDATE = "SCHEDULE_UPDATE";
export const ATTENDANCE_SCHEDULE_DELETE = "SCHEDULE_DELETE";
export const ATTENDANCE_SCHEDULE_ALL_DELETE = "SCHEDULE_ALL_DELETE";
export const ATTENDANCE_CURRENT_SCHEDULE_GET = "CURRENT_SCHEDULE_GET";
...
export const CAREER_V2_GET = "CAREER_V2_GET";
export const CAREERS_V2_APPLY_STATUSES = "CAREERS_V2_APPLY_STATUSES";
export const CAREERS_V2_TOP_FIVE_GET = "CAREERS_V2_TOP_FIVE_GET";
export const CAREER_V2_APPLY_UPDATE = "CAREER_V2_APPLY_UPDATE";
export const CAREER_V2_ADD = "CAREER_V2_ADD";
export const CAREER_V2_UPDATE = "CAREER_V2_UPDATE";
export const CAREER_V2_DELETE = "CAREER_V2_DELETE";
...
export const RECRUITMENTS_UPDATE_STATUS = "RECRUITMENTS_UPDATE_STATUS";
export const RECRUITMENTS_UPDATE_STAGE = "RECRUITMENTS_UPDATE_STAGE";
export const RECRUITMENT_LOG_NOTES_ADD = "RECRUITMENT_LOG_NOTES_ADD";
export const RECRUITMENT_LOG_GET = "RECRUITMENT_LOG_GET";
export const RECRUITMENT_EMAIL_SEND = "RECRUITMENT_EMAIL_SEND";
export const RECRUITMENT_EXCEL_TEMPLATE_GET = "RECRUITMENT_EXCEL_TEMPLATE_GET";
export const RECRUITMENT_PREVIEW_GET = "RECRUITMENT_PREVIEW_GET";
export const RECRUITMENT_ACCOUNT_GENERATE = "RECRUITMENT_ACCOUNT_GENERATE";
export const RECRUITMENT_ACCOUNT_TOKEN_GET = "RECRUITMENT_ACCOUNT_TOKEN_GET";
...
export const TALENT_POOLS_GET = "TALENT_POOLS_GET";
export const TALENT_POOL_ADD = "TALENT_POOL_ADD";
export const TALENT_POOL_DELETE = "TALENT_POOL_DELETE";
export const TALENT_POOL_GET = "TALENT_POOL_GET";
export const TALENT_POOL_FILTERS_GET = "TALENT_POOL_FILTERS_GET";
export const TALENT_POOL_CANDIDATES_GET = "TALENT_POOL_CANDIDATES_GET";
export const TALENT_POOL_CATEGORIES_GET = "TALENT_POOL_CATEGORIES_GET";
export const TALENT_POOL_CATEGORY_ADD = "TALENT_POOL_CATEGORY_ADD";
export const TALENT_POOL_CATEGORY_DELETE = "TALENT_POOL_CATEGORY_DELETE";

export const TALENT_POOL_SHARES_GET = "TALENT_POOL_SHARES_GET";
export const TALENT_POOL_SHARE_ADD = "TALENT_POOL_SHARE_ADD";
export const TALENT_POOL_SHARE_DELETE = "TALENT_POOL_SHARE_DELETE";

/** Public Talent Pool */
export const TALENT_POOL_SHARE_PUBLIC_AUTH = "TALENT_POOL_SHARE_PUBLIC_AUTH";
export const TALENT_POOL_SHARE_PUBLICS_GET = "TALENT_POOL_SHARE_PUBLICS_GET";
export const TALENT_POOL_SHARE_PUBLIC_GET = "TALENT_POOL_SHARE_PUBLIC_GET";
export const TALENT_POOL_SHARE_PUBLIC_FILTERS_GET =
  "TALENT_POOL_SHARE_PUBLIC_FILTERS_GET";
export const TALENT_POOL_SHARE_PUBLIC_MARK = "TALENT_POOL_SHARE_PUBLIC_MARK";
export const TALENT_POOL_SHARE_PUBLIC_CUTS_GET =
  "TALENT_POOL_SHARE_PUBLIC_CUTS_GET";
export const TALENT_POOL_SHARE_PUBLIC_CUT_ADD =
  "TALENT_POOL_SHARE_PUBLIC_CUT_ADD";
export const TALENT_POOL_SHARE_PUBLIC_CUT_DELETE =
  "TALENT_POOL_SHARE_PUBLIC_CUT_DELETE";
...
export const EMPLOYEE_PLACEMENTS_COUNT_GET = "EMPLOYEE_PLACEMENTS_COUNT_GET";
export const EMPLOYEE_ROLES_COUNT_GET = "EMPLOYEE_ROLES_COUNT_GET";
export const EMPLOYEE_STATUSES_COUNT_GET = "EMPLOYEE_STATUSES_COUNT_GET";

/** Employee Contract */
export const EMPLOYEE_CONTRACTS_GET = "EMPLOYEE_CONTRACTS_GET";
export const EMPLOYEE_CONTRACT_GET = "EMPLOYEE_CONTRACT_GET";
export const EMPLOYEE_CONTRACT_ADD = "EMPLOYEE_CONTRACT_ADD";
export const EMPLOYEE_CONTRACT_UPDATE = "EMPLOYEE_CONTRACT_UPDATE";
export const EMPLOYEE_CONTRACT_DELETE = "EMPLOYEE_CONTRACT_DELETE";
export const EMPLOYEE_CONTRACT_SALARY_READ = "EMPLOYEE_CONTRACT_SALARY_READ";

/** Employee Inventory */
export const EMPLOYEE_INVENTORIES_GET = "EMPLOYEE_INVENTORIES_GET";
export const EMPLOYEE_INVENTORY_GET = "EMPLOYEE_INVENTORY_GET";
export const EMPLOYEE_INVENTORY_ADD = "EMPLOYEE_INVENTORY_ADD";
export const EMPLOYEE_INVENTORY_UPDATE = "EMPLOYEE_INVENTORY_UPDATE";
export const EMPLOYEE_INVENTORY_DELETE = "EMPLOYEE_INVENTORY_DELETE";

/** Employee Device */
export const EMPLOYEE_DEVICES_GET = "EMPLOYEE_DEVICES_GET";
export const EMPLOYEE_DEVICE_GET = "EMPLOYEE_DEVICE_GET";
export const EMPLOYEE_DEVICE_ADD = "EMPLOYEE_DEVICE_ADD";
export const EMPLOYEE_DEVICE_UPDATE = "EMPLOYEE_DEVICE_UPDATE";
export const EMPLOYEE_DEVICE_DELETE = "EMPLOYEE_DEVICE_DELETE";

/** Employess Salary Column */
export const EMPLOYEE_SALARY_COLUMNS_GET = "EMPLOYEE_SALARY_COLUMNS_GET";
export const EMPLOYEE_SALARY_COLUMN_ADD = "EMPLOYEE_SALARY_COLUMN_ADD";
export const EMPLOYEE_SALARY_COLUMN_DELETE = "EMPLOYEE_SALARY_COLUMN_DELETE";
export const EMPLOYEE_SALARY_COLUMN_UPDATE = "EMPLOYEE_SALARY_COLUMN_UPDATE";

/** Employee Payslip */
export const EMPLOYEES_PAYSLIPS_POST = "EMPLOYEES_PAYSLIPS_POST";
export const EMPLOYEE_PAYSLIPS_GET = "EMPLOYEE_PAYSLIPS_GET";
export const EMPLOYEE_PAYSLIP_GET = "EMPLOYEE_PAYSLIP_GET";
export const EMPLOYEE_PAYSLIP_ADD = "EMPLOYEE_PAYSLIP_ADD";
export const EMPLOYEE_PAYSLIP_UPDATE = "EMPLOYEE_PAYSLIP_UPDATE";
export const EMPLOYEE_PAYSLIP_DELETE = "EMPLOYEE_PAYSLIP_DELETE";
export const EMPLOYEE_PAYSLIP_STATUS_COUNT_GET =
...
export const PROJECTS_EXPORT = "PROJECTS_EXPORT";

/** Project Category */
export const PROJECT_CATEGORIES_GET = "PROJECT_CATEGORIES_GET";
...
export const PROJECT_TASKS_COUNT_GET = "PROJECT_TASKS_COUNT_GET";
export const PROJECT_TASKS_DEADLINE_GET = "PROJECT_TASKS_DEADLINE_GET";
export const PROJECT_TASK_STAFF_COUNT_GET = "PROJECT_TASK_STAFF_COUNT_GET";
...
export const CONTRACT_HISTORIES_GET = "CONTRACT_HISTORIES_GET";
export const CONTRACT_HISTORY_GET = "CONTRACT_HISTORY_GET";
export const CONTRACT_HISTORY_ADD = "CONTRACT_HISTORY_ADD";
export const CONTRACT_HISTORY_UPDATE = "CONTRACT_HISTORY_UPDATE";
export const CONTRACT_HISTORY_DELETE = "CONTRACT_HISTORY_DELETE";
export const CONTRACT_HISTORY_LOGS_GET = "CONTRACT_HISTORY_LOGS_GET";
...
/* Dashboard company */
export const SIDEBAR_CLIENT_PROJECT = "SIDEBAR_CLIENT_PROJECT";
export const SIDEBAR_RECRUITMENT_CAREER = "SIDEBAR_RECRUITMENT_CAREER";
export const SIDEBAR_CLIENT_ATTENDANCE = "SIDEBAR_CLIENT_ATTENDANCE";
export const PROJECT_TASKS_COUNT_CLIENT_GET = "PROJECT_TASKS_COUNT_CLIENT_GET";
export const SIDEBAR_CLIENT_DASHBOARD = "SIDEBAR_CLIENT_DASHBOARD";
export const CAREER_V2_APPLY_EXPORT = "CAREER_V2_APPLY_EXPORT";

/** Notification / Announcement */
export const ANNOUNCEMENTS_GET = "ANNOUNCEMENTS_GET";
export const ANNOUNCEMENT_GET = "ANNOUNCEMENT_GET";
...
export const ANNOUNCEMENT_EMPLOYEE_GET = "ANNOUNCEMENT_EMPLOYEE_GET";
export const ANNOUNCEMENT_MORE_GET = "ANNOUNCEMENT_MORE_GET";
export const ANNOUNCEMENT_MAIL_GET = "ANNOUNCEMENT_MAIL_GET";
export const ANNOUNCEMENT_MAIL_SEND = "ANNOUNCEMENT_MAIL_SEND";
...
export const LEAVE_TYPE_UPDATE = "LEAVE_TYPE_UPDATE";
...
export const ATTENDANCES_USERS_COMPANY_GET = "ATTENDANCES_USERS_COMPANY_GET";

//Overtime access feature
export const OVERTIME_STATISTICS_GET = "OVERTIME_STATISTICS_GET";
export const OVERTIMES_GET = "OVERTIMES_GET";
export const OVERTIMES_USER_GET = "OVERTIMES_USER_GET";
export const OVERTIME_ADD = "OVERTIME_ADD";
export const OVERTIME_USER_ADD = "OVERTIME_USER_ADD";
export const OVERTIME_DELETE = "OVERTIME_DELETE";
export const OVERTIME_APPROVE = "OVERTIME_APPROVE";
export const OVERTIME_GET = "OVERTIME_GET";

//leave quota accesss feature
export const EMPLOYEE_LEAVE_QUOTAS_GET = "EMPLOYEE_LEAVE_QUOTAS_GET";
export const EMPLOYEE_LEAVE_QUOTA_ADD = "EMPLOYEE_LEAVE_QUOTA_ADD";
export const EMPLOYEE_LEAVE_QUOTA_UPDATE = "EMPLOYEE_LEAVE_QUOTA_UPDATE";
export const EMPLOYEE_LEAVE_QUOTA_DELETE = "EMPLOYEE_LEAVE_QUOTA_DELETE";

export const ATTENDANCE_RECAP_GET = "ATTENDANCE_RECAP_GET";
export const EMPLOYEE_NAMES_GET = "EMPLOYEE_NAMES_GET";
export const RESUME_PERSONAL_INFO_UPDATE = "RESUME_PERSONAL_INFO_UPDATE";
export const RESUME_SKILL_ADD = "RESUME_SKILL_ADD";
export const RESUME_SKILL_DELETE = "RESUME_SKILL_DELETE";
export const RESUME_EXPERIENCE_ADD = "RESUME_EXPERIENCE_ADD";
export const RESUME_EXPERIENCE_DELETE = "RESUME_EXPERIENCE_DELETE";
export const RESUME_EXPERIENCE_UPDATE = "RESUME_EXPERIENCE_UPDATE";
export const RESUME_TOOL_ADD = "RESUME_TOOL_ADD";
export const RESUME_TOOL_UPDATE = "RESUME_TOOL_UPDATE";
export const RESUME_TOOL_DELETE = "RESUME_TOOL_DELETE";
export const RECRUITMENTS_AI_PENDING_GET = "RECRUITMENTS_AI_PENDING_GET";
export const RESUME_EDUCATION_ADD = "RESUME_EDUCATION_ADD";
export const RESUME_EDUCATION_DELETE = "RESUME_EDUCATION_DELETE";
export const RESUME_EDUCATION_UPDATE = "RESUME_EDUCATION_UPDATE";
export const RESUME_LANGUAGE_ADD = "RESUME_LANGUAGE_ADD";
export const RESUME_LANGUAGE_UPDATE = "RESUME_LANGUAGE_UPDATE";
export const RESUME_LANGUAGE_DELETE = "RESUME_LANGUAGE_DELETE";
export const RESUME_EVALUATION_UPDATE = "RESUME_EVALUATION_UPDATE";
export const RECRUITMENT_APPROVE = "RECRUITMENT_APPROVE";
export const WORKDAY_COMPANIES_GET = "WORKDAY_COMPANIES_GET";
export const WORKDAY_STATISTICS_GET = "WORKDAY_STATISTICS_GET";
export const WORKDAYS_GET = "WORKDAYS_GET";
export const WORKDAY_GET = "WORKDAY_GET";
export const PUBLIC_HOLIDAYS_GET = "PUBLIC_HOLIDAYS_GET";
export const PUBLIC_HOLIDAYS_WORKDAY_GET = "PUBLIC_HOLIDAYS_WORKDAY_GET";
export const WORKDAY_ADD = "WORKDAY_ADD";
export const WORKDAY_UPDATE = "WORKDAY_UPDATE";
export const WORKDAY_DELETE = "WORKDAY_DELETE";
export const SIDEBAR_WORKDAY = "SIDEBAR_WORKDAY";
export const CHARGE_CODE_COMPANIES_GET = "CHARGE_CODE_COMPANIES_GET";
export const CHARGE_CODES_COMPANY_ADD = "CHARGE_CODES_COMPANY_ADD";
export const CHARGE_CODES_GET = "CHARGE_CODES_GET";
export const CHARGE_CODE_ADD = "CHARGE_CODE_ADD";
export const ATTENDANCE_CODE_ADD = "ATTENDANCE_CODE_ADD";
export const CHARGE_CODE_DELETE = "CHARGE_CODE_DELETE";
export const CHARGE_CODE_UPDATE = "CHARGE_CODE_UPDATE";
export const ATTENDANCE_CODE_UPDATE = "ATTENDANCE_CODE_UPDATE";
export const ATTENDANCE_CODE_DELETE = "ATTENDANCE_CODE_DELETE";
export const ATTENDANCE_CODES_GET = "ATTENDANCE_CODES_GET";
export const COMPANY_CODES_ADD = "COMPANY_CODES_ADD";
export const SIDEBAR_COMPANY_CODES = "SIDEBAR_COMPANY_CODES";
export const ATTENDANCE_VERIFICATIONS_GET = "ATTENDANCE_VERIFICATIONS_GET";
export const ATTENDANCE_HISTORY_VERIFICATIONS_GET =
  "ATTENDANCE_HISTORY_VERIFICATIONS_GET";
export const ATTENDANCE_VERIFICATION_APPROVE =
  "ATTENDANCE_VERIFICATION_APPROVE";
export const ATTENDANCE_VERIFICATION_REJECT = "ATTENDANCE_VERIFICATION_REJECT";
export const SIDEBAR_ATTENDANCE_VERIFICATION =
