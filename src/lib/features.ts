...
/** Attendance Shift */
export const ATTENDANCE_SHIFTS_GET = "ATTENDANCE_SHIFTS_GET";
export const ATTENDANCE_SHIFT_GET = "ATTENDANCE_SHIFT_GET";
export const ATTENDANCE_SHIFT_ADD = "ATTENDANCE_SHIFT_ADD";
export const ATTENDANCE_SHIFT_UPDATE = "ATTENDANCE_SHIFT_UPDATE";
export const ATTENDANCE_SHIFT_DELETE = "ATTENDANCE_SHIFT_DELETE";
export const ATTENDANCE_SHIFT_STATUS_UPDATE = "ATTENDANCE_SHIFT_STATUS_UPDATE";
