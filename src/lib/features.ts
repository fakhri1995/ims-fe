...
export const MENU_SETUP_ROLE = "MENU_SETUP_ROLE";
export const MENU_SETUP_REGISTRATION = "MENU_SETUP_REGISTRATION";
export const MENU_SETUP_STAGE = "MENU_SETUP_STAGE";
export const MENU_SETUP_STATUS = "MENU_SETUP_STATUS";
export const MENU_SETUP_TEMPLATE = "MENU_SETUP_TEMPLATE";
...
export const RECRUITMENT_ROLE_TYPES_GET = "RECRUITMENT_ROLE_TYPES_GET";
...
export const RECRUITMENT_JALUR_DAFTAR_LIST_GET =
  "RECRECRUITMENT_JALUR_DAFTAR_LIST_GET";
