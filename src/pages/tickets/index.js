...
import TicketTable from "../../components/screen/ticket/tickettable";
    ...
    >
      <div className="flex flex-col" id="mainWrapper">
        <div className="grid grid-cols-2 md:grid-cols-8 lg:grid-cols-10">
          ...
          {/* TABLE TIKET */}
          <TicketTable
            searcingfiltertickets={searcingfiltertickets}
            setsearcingfiltertickets={setsearcingfiltertickets}
            setQueryParams={setQueryParams}
            onKeyPressHandler={onKeyPressHandler}
            isAllowedGetTickets={isAllowedGetTickets}
            tickettypefiltertickets={tickettypefiltertickets}
            isAllowedToAddTicket={isAllowedToAddTicket}
            settickettypefiltertickets={settickettypefiltertickets}
            dataticketrelation={dataticketrelation}
            fromfiltertickets={fromfiltertickets}
            tofiltertickets={tofiltertickets}
            setfromfiltertickets={setfromfiltertickets}
            settofiltertickets={settofiltertickets}
            isAllowedGetTicket={isAllowedGetTicket}
            locfiltertickets={locfiltertickets}
            statusfiltertickets={statusfiltertickets}
            dataProfile={dataProfile}
            onFilterTickets={onFilterTickets}
            datatickets={datatickets}
            columnsTickets={columnsTickets}
            loadingtickets={loadingtickets}
            datarawtickets={datarawtickets}
