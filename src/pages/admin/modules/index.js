...
const ModulesIndex = ({
  ...
  const [praloadingmodulefeat, setpraloadingmodulefeat] = useState(
    module !== "" || typeof module !== "undefined" ? false : true
  );
  ...
  const [displayarrow, setdisplayarrow] = useState(
    featuredisplay === "" || typeof featuredisplay === "undefined"
      ? false
      : true
  );
          ...
          <div className=" col-span-1 md:col-span-3 flex flex-col p-3">
            <div className="flex justify-between mb-2 md:mb-5">
              ...
              <Button
                ...
                onClick={() => {
                  rt.push(
                    `/admin/modules/create/module?module=${datamodules.length}`
                  );
          ...
          <div className=" col-span-1 md:col-span-3 flex flex-col p-3">
            <div className="flex justify-between mb-2 md:mb-5">
              ...
              {/* <Button
                ...
                onClick={() => {
                  rt.push(
                    `/admin/modules/create/feature?feature=${listfeat.length}`
                  );
                }}
              >
                Tambah
