      ...
      <div className="border-b flex justify-between p-5 mb-8">
        ...
        {praloading ? null : (
          <Button
            ...
            onClick={() => {
              rt.push(
                `/admin/assets/update/${assettypeid}?codeparent=${codeparent}&idparent=${idparent}`
              );
            }}
          >
            Ubah
...
const AssetTypeDetail = ({ initProps, sidemenu, dataProfile, assettypeid }) => {
  ...
  return (
    ...
    >
            ...
            <div className=" col-span-4 flex justify-between p-2 pt-4 border-t-2 border-b-2 bg-white">
              ...
              <div className="flex mr-5 items-center">
                <Button
                  ...
                  onClick={() => {
                    const modeldata2 = modeldata.filter(
                      (doc1, idx1) => doc1.asset_id === Number(assettypeid)
                    );
      ...
      >
        <div className="flex flex-col p-5">
          ...
          >
            <div className="mb-2">
              <h5 className=" text-xs font-semibold">
                Berikut adalah child dari asset type "{displaydata.name}":
              </h5>
              <ul>
                {childassettype.length === 0 ? (
                  <>-</>
                  ...
                  childassettype.map((doc, idx) => {
                    return <li className="text-xs">- {doc.title}</li>;
                  })
                )}
              </ul>
            </div>
            <div className="mb-2">
              <h5 className=" text-xs font-semibold">
                1. Apakah anda ingin menghapus seluruh child dari asset type "
                {displaydata.name}"? <span className="hapusField1"></span>
              </h5>
              <Radio.Group
            ...
            <div className="mb-2">
              <h5 className=" text-xs font-semibold">
                2. Jika tidak, pilih Asset Type sebagai parent untuk child dari
                Asset Type "{displaydata.name}"!{" "}
                <span className="hapusField2"></span>
              </h5>
              <TreeSelect
          ...
          <div id="step2" className="rounded border bg-gray-50 p-5 hidden">
            <div className="mb-2">
              <h5 className=" text-xs font-semibold">
                Berikut adalah Model yang dimiliki Asset Type "
                {displaydata.name}":
              </h5>
              <ul>
                {modeldata.length === 0 ||
                modeldata
                  ...
                  .indexOf(Number(assettypeid)) === -1
                  ? "-"
                  : modeldata.map((doc, idx) => {
                      if (doc.asset_id === Number(assettypeid)) {
                        return <li className="text-xs">- {doc.name}</li>;
                      }
                    })}
              </ul>
            </div>
            <div className="mb-2">
              <h5 className=" text-xs font-semibold">
                1. Apakah anda ingin menghapus seluruh model yang dimiliki Asset
                Type "{displaydata.name}"? <span className="hapusField1"></span>
              </h5>
              <Radio.Group
            ...
            <div className="mb-2">
              <h5 className=" text-xs font-semibold">
                2. Jika tidak, pilih Asset Type untuk memindahkan seluruh model
                yang dimiliki oleh Asset Type "{displaydata.name}"!{" "}
                <span className="hapusField2"></span>
              </h5>
              <TreeSelect
      ...
      <Modal
        title={<h1 className="font-semibold">Konfirmasi Hapus Asset Type</h1>}
      ...
      >
        Apakah anda yakin ingin menghapus Asset Type{" "}
