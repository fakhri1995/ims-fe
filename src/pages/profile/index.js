    ...
    >
      <div className="w-full h-auto border-t-2 p-4 relative">
        <div className="relative md:absolute md:top-4 md:right-8 mb-5">
          ...
          {editable ? (
            <button className=" bg-gray-700 hover:bg-gray-800 border text-white py-1 px-3 rounded-md w-24 md:w-40">
              Save
            </button>
          ) : (
            <button
        ...
        <div className="flex flex-col justify-center">
          <div className="flex flex-col md:flex-row mb-8">
            ...
            <div className="flex flex-col">
              <h1 className=" text-base md:text-2xl font-semibold mb-1">
                {dataProfile.data.fullname}
              </h1>
              <div className="flex">
                <h1 className=" text-xs md:text-sm font-normal mr-1 md:mr-3 pt-1">
                  {dataProfile.data.email}{" "}
                </h1>
                <div className="mr-1 md:mr-3 pt-1">|</div>
                <div className=" bg-blue-100 text-blue-600 text-sm md:text-base border-blue-600 border py-1 md:py-1 px-1 md:px-3 rounded-md">
                  USER
                </div>
              </div>
            </div>
