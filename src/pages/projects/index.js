...
import MyTaskProject from "../../components/screen/project/MyTaskProject";
import ProjectStatistic from "../../components/screen/project/ProjectStatistic";
      ...
      >
        <div className="flex flex-col xl:col-span-4 gap-6">
          ...
          <ProjectStatistic
            ...
            dataProjectDeadline={dataProjectDeadline}
          />
        ...
        <div className="grid grid-cols-2 xl:flex flex-col xl:col-span-2 gap-6">
          ...
          <MyTaskProject
            dataMyTaskList={dataMyTaskList}
            loadingMyTaskList={loadingMyTaskList}
            pageMyTaskList={pageMyTaskList}
            rowsMyTaskList={rowsMyTaskList}
            dataRawMyTaskList={dataRawMyTaskList}
            setPageMyTaskList={setPageMyTaskList}
            setSortOrder={setSortOrder}
            handleSortTasks={handleSortTasks}
            dataProjectList={dataProjectList}
            handleAddTask={handleAddTask}
            isAllowedToAddTask={isAllowedToAddTask}
            isAllowedToGetTasks={isAllowedToGetTask}
            sortOrder={sortOrder}
            sortColumn={sortColumn}
            initProps={initProps}
            dataProfile={dataProfile}
            setCurrentTaskId={setCurrentTaskId}
            setModalDetailTask={setModalDetailTask}
