  ...
  const handleUpdateTicket = () => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/updateTicket`, {
      ...
      body: JSON.stringify({
        ...updatedata,
        ["location_id"]:
          updatedata.location_id === null ? 0 : updatedata.location_id,
      }),
    })
      .then((res) => res.json())
      .then((res2) => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/getTicket?id=${ticketid}`, {
      ...
      .then((res2) => {
        const updata = {
          id: Number(ticketid),
          requester_id:
            res2.data.ticket.requester.id === 0
              ? null
              : res2.data.ticket.requester.id,
          ...
          location_id:
            res2.data.ticket.ticketable.location_id === 0
              ? null
              : res2.data.ticket.ticketable.location_id,
            ...
            <div className=" col-span-4 flex justify-between pt-4 border-t-2 border-b-2 bg-white">
              ...
              <div className="flex space-x-2">
                <Link href={`/tickets/detail/${ticketid}`}>
                  <Button
                    type="default" /*onClick={() => { console.log(updatedata); console.log(filesupload) }}*/
                  >
                    Batal
                  </Button>
                </Link>
              ...
              <div className="shadow-md border py-5 px-10 flex flex-col rounded-md mb-5">
                    ...
                    {users.map((doc, idx) => {
                      return (
                        <Select.Option
                          ...
                          value={doc.id}
                          company_name={
                            doc.company === null ? "-" : doc.company.name
                          }
                        >
                          {doc.name}
                        </Select.Option>
                ...
                <div className="flex flex-col mb-5">
                  ...
                  <DatePicker
                    allowClear={false}
                    value={
                      updatedata.raised_at === ""
                        ? null
                        : moment(updatedata.raised_at)
                    }
                ...
                <div className="flex flex-col mb-5">
                  ...
                  <DatePicker
                    ...
                    onChange={(date, datestring) => {
                      datestring === ""
                        ? (setupdatedata({ ...updatedata, closed_at: "" }),
                  ...
                  {notclosed ? (
                    <p className="mb-0 text-red-500">
                      Date closed dapat dirubah jika status ticket telah{" "}
              ...
              <div className="shadow-md border py-5 px-10 flex flex-col rounded-md mb-5">
                ...
                >
                  ...
                  <div className="mb-5 flex flex-col">
                    ...
                    <DatePicker
                      defaultValue={
                        updatedata.incident_time === null
                          ? null
                          : moment(updatedata.incident_time)
                      }
                      name="incident_time"
                      showTime
                  ...
                  <Form.Item>
                    <div className="flex flex-col">
                      <p className="mb-2 ml-1">
                        Bukti Incident (Support File: PNG/JPEG, PDF, dan Word)
                      </p>
                      <label
                      ...
                      >
                        ...
                        {loadingfoto ? (
                          ...
                          <>
                            {" "}
                            <UploadOutlined style={{ marginRight: `1rem` }} />
                          </>
                        )}
