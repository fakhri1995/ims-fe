      ...
      fetch(
        ...
        .then((res2) => {
          reltipeitemdata === -3
            ...
            : reltipeitemdata === -4
            ? setrelitemdata(res2.data.data)
            : null;
          reltipeitemdata === -1 || reltipeitemdata === -2
            ? (setrelitemdata(res2.data), setrelitemdata2(res2.data))
            : null;
  ...
  return (
    ...
    >
        ...
        <div className="md:col-span-5 col-span-1 flex flex-col">
          <div className="flex flex-col w-full mb-8">
            <p className="mb-1 font-semibold">
              Relationship Type <span className="relitemtambah"></span>
            </p>
            <Select
              ...
              onChange={(value, option) => {
                setnewdata({
                  ...newdata,
                  relationship_asset_id:
                    typeof value === "undefined" ? null : value,
                  is_inverse:
                    typeof option === "undefined" ? null : option.is_inverse,
                });
                setreltipeitemdata(
                  typeof option === "undefined" ? -10 : option.type_id
                );
                setreldetailitemdata(
                  typeof option === "undefined" ? "" : option.detail
                );
                typeof value === "undefined"
                  ? setrelitemdata([])
                  : setrelitemdatatrigger(value);
              }}
            >
            ...
            {displaydatarelations.length < 1 && (
              <p className="text-red-500 text-sm">
                Data Relationship Type kosong, silahkan tambah data melalui{" "}
                <Link
          ...
          <Table
            ...
            rowKey={
              reltipeitemdata === -1 || reltipeitemdata === -2 ? "id" : "id"
            }
            scroll={{ x: 200 }}
      ...
      <Modal
        title={
          <>
            Apakah Anda yakin ingin menambahkan Relationship ke Item berikut
            ini?
          </>
        }
        visible={modaladd}
