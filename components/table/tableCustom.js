...
const TableCustomStaffTask = ({ dataSource, setDataSource, columns, loading, pageSize, total, setpraloading, initProps, setpage, pagefromsearch, setdataraw, setsortingstaff, searcingstaff, intervaldatestaff }) => {
    return (
        <Table
            className='tableTypeTask'
            dataSource={dataSource}
...
const TableCustomTickets = ({ dataSource, setDataSource, columns, loading, pageSize, total, setpraloading, initProps, setpage, pagefromsearch, setdataraw, setsorting, sorting, searching, tickettype, fromdate, todate, location, status, dataprofile }) => {
    const rt = useRouter()
    const [rowstate, setrowstate] = useState(0)
    return (
        <Table
