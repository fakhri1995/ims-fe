...
const DrawerTaskTypesUpdate = ({
  ...
  const [loadingdetailtipetaskupdate, setloadingdetailtipetaskupdate] =
    useState(false);
    ...
    if (trigger !== -1) {
      ...
      fetch(
        ...
        .then((res2) => {
          ...
          res2.data.name !== "" && res2.data.description !== ""
            ? setdisabledupdate(false)
            : setdisabledupdate(true);
          var tempisbarismatriks = res2.data.works.map((m) =>
            typeof m.details.is_general !== "undefined"
              ? m.details.is_general
                ? true
                : false
              : 1
          );
                                  ...
                                  onChange={(e) => {
                                    ...
                                    if (doc.id) {
                                      ...
                                      if (idxdataupdate === -1) {
                                        ...
                                        var temp = [...dataupdate.update_works];
                                        temp[idxdataupdate].description =
                                          e.target.value;
                                        setdataupdate((prev) => ({
                                          ...prev,
                                          update_works: temp,
                                          ...
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              if (doc.id) {
                                                ...
                                                var temp2 = [
                                                  ...dataupdate.add_works,
                                                ];
                                                temp2[idx - workslen].lists =
                                                  tempdisplay[idx].lists;
                                                setdataupdate((prev) => ({
                                                  ...prev,
                                                  add_works: temp2,
                                        ...
                                        >
                                          ...
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              tempdisplay[idx].columns.splice(
                                                idx2,
                                                1
                                              );
                                              setdatadisplay((prev) => ({
                                    ...
                                    <div className="flex items-center">
                                      <div
                                        ...
                                        onClick={() => {
                                          ...
                                          tempdisplay[idx].columns.push(
                                            tempcolumnmatriks[idx]
                                          );
                                          setdatadisplay((prev) => ({
                                            ...prev,
                                            works: tempdisplay,
                                      ...
                                      <Input
                                        ...
                                        onChange={(e) => {
                                          var temptempcolumnsmatriks = [
                                            ...tempcolumnmatriks,
                                          ];
                                          temptempcolumnsmatriks[idx] =
                                            e.target.value;
                                          settempcolumnmatriks(
                                            temptempcolumnsmatriks
                                          );
                                        }}
                                        bordered={false}
                                      />
                                  ...
                                  <div className="mb-3 flex flex-col">
                                    <div className="mb-2">
                                      <RadioNotRequired
                                        ...
                                        onChangeRadio={(e) => {
                                          var temparrisbarismatriks = [
                                            ...isbarismatriks,
                                          ];
                                          temparrisbarismatriks[idx] =
                                            e.target.value;
                                          setisbarismatriks(
                                            temparrisbarismatriks
                                          );
                                          var tempdisplay = [
                                            ...datadisplay.works,
                                          ];
                                          tempdisplay[idx].is_general =
                                            e.target.value;
                                          setdatadisplay((prev) => ({
                                            ...prev,
                                            works: tempdisplay,
                                          ...
                                          if (doc.id) {
                                            ...
                                            if (idxdataupdate === -1) {
                                              ...
                                              temp2[idxdataupdate].is_general =
                                                tempdisplay[idx].is_general;
                                              setdataupdate((prev) => ({
                                                ...prev,
                                                update_works: temp2,
                                      ...
                                      <div className="mb-2">
                                        ...
                                        <div className="flex items-center">
                                          ...
                                          <Input
                                            ...
                                            onChange={(e) => {
                                              var temptemprowssmatriks = [
                                                ...temprowmatriks,
                                              ];
                                              temptemprowssmatriks[idx] =
                                                e.target.value;
                                              settemprowmatriks(
                                                temptemprowssmatriks
                                              );
                                            }}
                                            bordered={false}
                                          />
                                ...
                                <div
                                  ...
                                  onClick={async () => {
                                    ...
                                    temp2[idx].id
                                      ...
                                      : setdataupdate((prev) => ({
                                          ...prev,
                                          add_works: temp2.filter(
                                            (dfil) =>
                                              typeof dfil.id === "undefined" &&
                                              dfil.name !== temp2[idx].name
                                          ),
                                        }));
