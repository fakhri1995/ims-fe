                ...
                loadingsave ?
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className=' mb-2 flex'>
                                <DatePicker suffixIcon={<CalendartimeIconSvg size={15} color={`#000000`} />} style={{ width: `100%` }} showTime allowClear className="datepickerStatus" defaultValue={datapayload.raised_at === null ? null : moment(datapayload.raised_at)} onChange={(date, datestring) => {
                                    setdatapayload({ ...datapayload, raised_at: datestring === "" ? null : datestring })
                                }}
                                />
                            </div>
                        </div>
                        <div className="flex flex-col mb-6">
                            ...
                            <div className=' mb-2 flex'>
                                <DatePicker suffixIcon={<CalendartimeIconSvg size={15} color={`#000000`} />} style={{ width: `100%` }} showTime allowClear className="datepickerStatus" defaultValue={datapayload.closed_at === null ? null : moment(datapayload.closed_at)} onChange={(date, datestring) => {
                                    setdatapayload({ ...datapayload, closed_at: datestring === "" ? null : datestring })
                                }}
                                />
                            </div>
                        </div>
                        ...
                        <div className=' mb-6 flex flex-col'>
                            ...
                            <Input defaultValue={datapayload.product_id} onChange={(e) => {
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className=' mb-2 flex'>
                                <DatePicker suffixIcon={<CalendartimeIconSvg size={15} color={`#000000`} />} style={{ width: `100%` }} showTime allowClear className="datepickerStatus" defaultValue={datapayload.incident_time === null ? null : moment(datapayload.incident_time)} onChange={(date, datestring) => {
                        ...
                        <div className=' mb-6 flex flex-col'>
                            ...
                            <Input defaultValue={datapayload.pic_name} onChange={(e) => {
                        ...
                        <div className=' mb-6 flex flex-col'>
                            ...
                            <Input defaultValue={datapayload.pic_contact} onChange={(e) => {
                        ...
                        <div className=' mb-6 flex flex-col'>
                            ...
                            <Input.TextArea rows={5} defaultValue={datapayload.description} onChange={(e) => {
