                ...
                loadingsave ?
                    ...
                    <div className=' flex flex-col px-3'>
                        <div className=' my-5 flex items-center'>
                            <div id='ind' className={`mr-4 text-primary100 bg-white hover:bg-primary100 hover:border-primary100 border-2 hover:text-white border-primary100 ${datapayload.assignable_type === false && `border-opacity-20`} px-6 btn btn-sm`} onClick={() => {
                                setdatapayload({ ...datapayload, assignable_type: true })
                            }}>
                                Individu
                            </div>
                            <div id='grup' className={`mr-4 text-primary100 bg-white hover:bg-primary100 hover:border-primary100 border-2 hover:text-white border-primary100 ${datapayload.assignable_type === true && `border-opacity-20`} px-6 btn btn-sm`} onClick={() => {
                        ...
                        <div className="my-5 flex flex-col max-h-screen overflow-y-scroll">
                            {
                                loadinggetengs ?
                                    ...
                                    listengs.map((eng, idx) => (
                                        <div className={`${datapayload.assignable_id === eng.id && `bg-primary10`} mb-4 flex items-center cursor-pointer`} onClick={() => {
                                            setdatapayload({ ...datapayload, assignable_id: eng.id })
                                            setdisabledtrigger(prev => prev + 1)
                                        }}>
                                            <div className=' w-10 h-10 rounded-full mr-3'>
                                                <img src={eng.profile_image === "" || eng.profile_image === "-" ? "/image/staffTask.png" : `${eng.profile_image}`} className=' object-contain w-10 h-10' alt="" />
                                            </div>
                            ...
                            }
                            {
                                loadinggetgroups ?
                                    ...
                                    listgroups.map((group, idx) => (
                                        <div className={`${datapayload.assignable_id === group.id && `bg-primary10`} mb-4 flex items-center cursor-pointer`} onClick={() => {
