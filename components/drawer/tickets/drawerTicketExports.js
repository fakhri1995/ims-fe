...
const DrawerTicketExports = ({ title, visible, onvisible, onClose, buttonOkText, disabled, initProps, refreshtickets, setrefreshtickets, dataprofile }) => {
    //useState
    ...
    return (
        <DrawerCore
            ...
            onClick={() => { console.log(datapayload); handleExports() }}
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className=' mb-2 flex'>
                                <DatePicker.RangePicker style={{ width: `100%` }} allowClear className="datepickerStatus"
                                    onChange={(dates, datestrings) => {
                                        if (datestrings[0] === '' && datestrings[1] === '') {
                                            setdatapayload({ ...datapayload, from: "", to: "" })
                                        }
                                        else {
                                            setdatapayload({ ...datapayload, from: moment(datestrings[0]).locale('id').format('YYYY-MM-DD'), to: moment(datestrings[1]).locale('id').format('YYYY-MM-DD') })
                                        }
                                    }}
                                />
                            </div>
                            ...
                            <div className="mb-2 flex">
                                ...
                                >
                                    <div className="flex flex-col">
                                        ...
                                        <div className='mb-1'>
                                            <Checkbox value={coreopt[2]}>Lokasi Pembuatan Tiket</Checkbox>
                                        </div>
                                        <div className='mb-1'>
                        ...
                        </div>
                        {
                            datapayload.type === null ?
                                <div>
                                    <Label>Jika Jenis Tiket tidak dipilih, maka akan menampilkan semua parameter detail masalah</Label>
                                </div>
                                :
                                <div className="flex flex-col mb-6">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <div onClick={() => {
                                            ...
                                            setdatapayload({ ...datapayload, secondary_attributes: arr })
                                        }}>
                                            <Text color={`green`} cursor={`pointer`}>Pilih Semua</Text>
                                        </div>
                                    </div>
                                    <div className="mb-2 flex">
                                        ...
                                        >
                                            <div className="flex flex-col">
                                                ...
                                                <div className='mb-1'>
                                                    <Checkbox value={secondopt[6]}>Deskripsi Kerusakan</Checkbox>
                                                </div>
                                            </div>
                                        </Checkbox.Group>
                                    </div>
