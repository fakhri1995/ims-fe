        ...
        <div className={'bg-white w-96 h-auto p-2 top-6 relative'} style={{ boxShadow: '0px 0px 3px rgba(50, 50, 50, 0.75)' }}>
            <Link href="/hardware">
                <div className={'group flex py-2 cursor-pointer hover:bg-gray-100'}>
                    <div className={'px-4 my-auto w-1/6'}>
                        ...
                        <svg className={'relative -top-5 fill-current text-black group-hover:text-green-500'} width="30" height="30" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.2" d="M9 42.75V18C9 16.8065 9.47411 15.6619 10.318 14.818C11.1619 13.9741 12.3065 13.5 13.5 13.5H58.5C59.6935 13.5 60.8381 13.9741 61.682 14.818C62.5259 15.6619 63 16.8065 63 18V42.75H9Z" />
            ...
            <Link href="/software">
                <div className={'group flex py-2 cursor-pointer hover:bg-gray-100'}>
                    <div className={'px-4 my-auto w-1/6'}>
                        <svg className={'relative -top-5 fill-current text-black group-hover:text-green-500'} width="30" height="30" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.2" d="M63 15.75V56.25C63 56.8467 62.7629 57.419 62.341 57.841C61.919 58.2629 61.3467 58.5 60.75 58.5H11.25C10.6533 58.5 10.081 58.2629 9.65901 57.841C9.23705 57.419 9 56.8467 9 56.25V15.75C9 15.1533 9.23705 14.581 9.65901 14.159C10.081 13.7371 10.6533 13.5 11.25 13.5H60.75C61.3467 13.5 61.919 13.7371 62.341 14.159C62.7629 14.581 63 15.1533 63 15.75Z" />
