...
const Aset2IconSvg = ({ size, color }) => {
    const aset2IconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-box" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <polyline points="12 3 20 7.5 20 16.5 12 21 4 16.5 4 7.5 12 3" />
            <line x1={12} y1={12} x2={20} y2="7.5" />
            <line x1={12} y1={12} x2={12} y2={21} />
    ...
    return (
        <Icon component={aset2IconSvg}></Icon>
    )
}
const EditIconSvg = ({ size, color }) => {
    const editIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-pencil" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const EmailIconSvg = ({ size, color }) => {
    const emailIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-mail" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const PhoneIconSvg = ({ size, color }) => {
    const phoneIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-phone" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const WebIconSvg = ({ size, color }) => {
    const webIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-world" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const LocationIconSvg = ({ size, color, id }) => {
    ...
    return (
        <Icon id={id} component={locationIconSvg}></Icon>
    )
}
...
const SortingIconSvg = ({ size, color }) => {
    ...
    return (
        <Icon component={sortingIconSvg}></Icon>
    )
}
const DownIconSvg = ({ size, color }) => {
    const downIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <polyline points="6 9 12 15 18 9" />
        </svg>
    )
    return (
        <Icon component={downIconSvg}></Icon>
    )
}
const ExternalLinkIconSvg = ({ size, color }) => {
    const externallinkIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-external-link" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Icon component={externallinkIconSvg}></Icon>
    )
}
const CameraIconSvg = ({ size, color }) => {
    const cameraIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-camera" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Icon component={cameraIconSvg}></Icon>
    )
}
const RefreshIconSvg = ({ size, color }) => {
    const refreshIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-refresh" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Icon component={refreshIconSvg}></Icon>
    )
}
const SquarePlusIconSvg = ({ size, color }) => {
    const squareplusIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-square-plus" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Icon component={squareplusIconSvg}></Icon>
    )
}
const NotesIconSvg = ({ size, color }) => {
    const notesIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-notes" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Icon component={notesIconSvg}></Icon>
    )
}
const FaxIconSvg = ({ size, color }) => {
    const faxIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-printer" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Icon component={faxIconSvg}></Icon>
    )
}
const PkpIconSvg = ({ size, color }) => {
    const pkpIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-receipt-tax" width={size} height={size} viewBox="0 0 24 24" strokeWidth="1.5" stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const ArmChairlIconSvg = ({ size, color }) => {
    const armChairlIconSvg = () => (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-armchair" width={44} height={44} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ff2825" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Icon component={armChairlIconSvg}></Icon>
    )
}
const AssetIconSvg = ({ size, color }) => {
        ...
        <svg width={size} height={size} viewBox="0 0 72 73" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_d_3173_31461" x={0} y="0.142822" width={72} height={72} filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_3173_31461" />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_3173_31461" result="shape" />
                </filter>
            </defs>
        </svg>
    ...
    return (
        <Icon component={assetIconSvg}></Icon>
    )
}
...
const ContractIconSvg = () => {
    ...
    return (
        <Icon component={contractIconSvg}></Icon>
    )
}

const IconBroadcast = (props) => {
    const svgbroadcast = () => (
        <svg id="color" enableBackground="new 0 0 24 24" height={props.height ?? 40} viewBox="0 0 24 24" width={props.width ?? 40} xmlns="http://www.w3.org/2000/svg"><path d="m8.25 21.25c-2.481 0-4.5-2.019-4.5-4.5 0-.48.071-.937.212-1.357.175-.524.742-.805 1.265-.631.524.175.807.742.631 1.265-.071.216-.108.459-.108.723 0 1.378 1.122 2.5 2.5 2.5 1.146 0 2.167-.807 2.426-1.917.125-.538.666-.874 1.201-.746.538.125.872.664.746 1.201-.476 2.038-2.274 3.462-4.373 3.462z" fill="#0f93ff" /><path d="m23.25 21.5c-.07 0-.14-.01-.208-.029l-22.5-6.5c-.321-.093-.542-.387-.542-.721v-4.5c0-.334.221-.628.542-.721l22.5-6.5c.227-.063.471-.021.659.121s.299.364.299.6v17.5c0 .236-.111.458-.299.6-.132.098-.29.15-.451.15z" fill="#0f93ff" /><g fill="#0f93ff"><path d="m23 22.25c-.552 0-1-.448-1-1v-18.5c0-.552.448-1 1-1s1 .448 1 1v18.5c0 .552-.448 1-1 1z" /><path d="m1 16.25c-.552 0-1-.448-1-1v-6.5c0-.552.448-1 1-1s1 .448 1 1v6.5c0 .552-.448 1-1 1z" /></g></svg>
    )
    return (
        <Icon component={svgbroadcast} style={{ marginRight: `0.5rem` }} />
    )
}

const Iconquestion = (props) => {
    const svgquestion = () => (
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={props.width ?? 40} height={props.height ?? 40} viewBox="0 0 356.62 356.62" style={{ enableBackground: 'new 0 0 356.62 356.62' }} xmlSpace="preserve">
            <g>
                <path d="M178.31,0C79.99,0,0,79.99,0,178.311S79.99,356.62,178.31,356.62s178.31-79.989,178.31-178.31S276.63,0,178.31,0z
		 M178.31,326.62C96.532,326.62,30,260.089,30,178.311S96.532,30,178.31,30s148.31,66.532,148.31,148.311
		S260.088,326.62,178.31,326.62z" fill="#0f93ff" />
                <path d="M178.31,66.949c-35.58,0-64.527,28.947-64.527,64.527c0,8.284,6.716,15,15,15s15-6.716,15-15
		...
		C242.837,95.896,213.89,66.949,178.31,66.949z" fill="#0f93ff" />
    ...
    return (
        <Icon component={svgquestion} style={{ marginRight: `0.5rem` }} />
    )
}
